...
object SbtMultiBuild extends Build {
  ...
  val camel = Seq("camel-core", "camel-scala", "camel-test","camel-test-spring", "camel-jetty","camel-jms", "camel-spring", "camel-ftp", "camel-netty").map("org.apache.camel" % _ % "2.12.0")
